...
Revision ID: 64b8b6357f1e
Revises: 
Create Date: 2026-07-12 17:08:24.621719
...
def upgrade() -> None:
    ...
    op.create_table('supervisor_balance_logs',
    ...
    op.create_table('site_supervisors',
    ...
    op.create_table('ajax_driver_logs',
    sa.Column('log_id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_table('hitachi_driver_logs',
    sa.Column('log_id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('driver_id', sa.Integer(), nullable=False),
    sa.Column('site_id', sa.Integer(), nullable=False),
    sa.Column('date', sa.Date(), nullable=False),
